...
import { FaStar, FaCrown, FaGift } from 'react-icons/fa';
...
return ( <div className="min-h-screen bg-darker pt-20 pb-12"> <Navbar />
  ...
  <div className="max-w-6xl mx-auto px-4 py-12">
    ...
    >
      <div className="flex justify-center mb-4">
        <FaStar className="text-4xl text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary" />
      </div>
